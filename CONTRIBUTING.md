# Contributing to phonolab

Thank you for your interest in contributing to phonolab! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/phonolab.git
   cd phonolab
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/phonolab.git
   ```
...
By contributing to phonolab, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
